...
namespace Concepts.Ring8.Tunity
{
    ...
    /// 
    /// </summary>
    public class VersionRemovedModification: Modification
    {
        /// <summary>
        /// Add modification
        /// </summary>
        ...
        public VersionRemovedModification(DateTime time, Person modifier, Version version) :
        ...
        public override String LongDescription
        {
            get
            {
               return"";// String.Format(
                     // Yesugi.ResourceManager.GetString("Modification.VersionRemoved"),
