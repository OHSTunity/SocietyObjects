...
namespace Concepts.Ring8.Tunity
{
    ...
    /// </summary>
    public class ModificationTarget : Relation
    {
       
        public ModificationTarget()
        {
        }

        public ModificationTarget(Modification mod, Something target)
        {
            SetWhatIs(target);
            SetToWhat(mod);
        }
        ...
        [SynonymousTo("WhatIs")]
        public readonly Something Target;
