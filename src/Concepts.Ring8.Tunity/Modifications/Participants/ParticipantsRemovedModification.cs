...
namespace Concepts.Ring8.Tunity
{
    ...
    /// 
    /// </summary>
    public class ParticipantsRemovedModification : Modification
    {
        /// <summary>
        /// Add modification
        /// </summary>
        ...
        public ParticipantsRemovedModification(DateTime time, Person modifier,
        ...
        {
            if (mod is ParticipantsRemovedModification) //Combine
            {
            ...
            else if (mod is ParticipantsAddedModification)
            {
                foreach (Person person in (mod as ParticipantsAddedModification).Participants)
                {
                    if (RemoveParticipant(person))
                    {
                        (mod as ParticipantsAddedModification).RemoveParticipant(person);
                    }
                }
                Boolean mEmpty = (mod as ParticipantsAddedModification).Empty;
        ...
        public override String LongDescription
        {
            get
            {
                String result ="";// String.Format(
                   // Yesugi.ResourceManager.GetString("Modification.ParticipantsRemoved"));
